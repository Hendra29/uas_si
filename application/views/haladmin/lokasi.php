                ...
                <thead>
                                    ...
                                    $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="center"><?php echo $row->tanggal; ?></div></td>
                            ...
                            <a onclick="edit_lokasi_popup(<?php echo $row->id;?>);" type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                            <a class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Delete" href="<?php echo site_url('data_lokasi/hapus/'.$row->id)?>" onclick="return confirm('Anda Yakin ?');"><i class="fa fa-times"></i>
                            </a></div></td>
                                        </tr>
                                    <?php }
                                             }
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <textarea id="judul" name="judul" class="form-control" type="text" rows="1" cols="73" required></textarea>
                                         </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="box-body pad">
                                         <textarea id="isi" name="isi" class="form-control" type="text" rows="1" cols="73" required></textarea>
                                         </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <div class="box-body pad">
                                         <textarea id="tanggal" name="tanggal" class="form_control" type="text" rows="1" cols="73" required></textarea>
                                         </div>
                                        </div>
